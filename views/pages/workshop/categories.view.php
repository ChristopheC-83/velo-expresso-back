...
<div class="container">
    ...
    <?php foreach ($categories as $category) : ?>
        <?php if (empty($_POST['id']) || $_POST['id'] != $category['id']) : ?>
            <div class="row w-100 border p-2">
                ...
                <div class="col-2 text-center">
                    <form action="<?= URL ?>admin/workshop/delete_category" method="POST" onSubmit="return confirm('On confirme la suppression ?')">
                        <input type="hidden" name="id" value=<?= $category['id'] ?>>
        ...
        <?php else :  ?>
            <form method="POST" action="<?= URL ?>admin/workshop/modify_category">
                <div class="row w-100 border p-2">
                    <input type="hidden" name="id" value=<?= $category['id'] ?>>
                    <div class="col-5">
                    ...
                    <div class="col-3 text-center">
                        <input type="number" name="position" value="<?= $category['position'] ?>">
                    </div>
...
<div class="container mt-5">
    <div class="row">
        <div class=" col-11 col-sm-10 col-lg-8 mx-auto">
            <form action="<?= URL ?>admin/workshop/send_new_category" method="POST" class="row">
